.class public Lcom/sun/mail/imap/protocol/d;
...
.method private parseBodyExtension(Lcom/sun/mail/iap/Response;)V
    ...
    :cond_0
    :goto_0
    mul-long/2addr p12, p8

    #disallowed odex opcode
    #invoke-super-quick {}, vtable@12745
    nop

    if-gtz p223, :cond_0

    shr-int/lit8 p0, p63, 0x36

    #Type index out of bounds: 22752
    #filled-new-array/range {p36029 .. p36151}, type@22752
    nop

    #unknown opcode: 0xff
    nop

    #Field index out of bounds: 34295
    #iput-byte p5, p9, field@34295
    nop

    div-int p13, p42, p244

    #Field index out of bounds: 10935
    #disallowed odex opcode
    #sput-volatile p206, field@10935
    nop

    #unknown opcode: 0x7a
    nop

    #Field index out of bounds: 49640
    #disallowed odex opcode
    #iput-volatile p11, p8, field@49640
    nop

    #Field index out of bounds: 53252
    #sget-wide p241, field@53252
    nop

    const/16 p112, -0x4f52

    #Field index out of bounds: 40574
    #iget-char p12, v1, field@40574
    nop
    ...
    #Type index out of bounds: 38595
    #filled-new-array {}, type@38595
    nop

    #Field index out of bounds: 19167
    #sput-char p148, field@19167
    nop

    #Method index out of bounds: 32637
    #disallowed odex opcode
    #invoke-object-init/range {p19750 .. p19757}, method@32637
    nop

    add-long p217, p246, v1

    long-to-double p2, p10
