...
.field private static final af:Landroid/support/v4/view/br;
...
.field private W:Landroid/support/v4/view/bn;
...
.field private final f:Landroid/support/v4/view/bj;
...
.field private n:Landroid/support/v4/view/bp;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/view/ViewPager;->af:Landroid/support/v4/view/br;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Landroid/support/v4/view/ViewPager;->f:Landroid/support/v4/view/bj;
...
.method private a(IIII)V
    ...
    invoke-virtual {p0, v0}, Landroid/support/v4/view/ViewPager;->b(I)Landroid/support/v4/view/bj;

    move-result-object v3

    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->m:Landroid/widget/Scroller;

    iget v3, v3, Landroid/support/v4/view/bj;->e:F
    ...
    iget v0, v0, Landroid/support/v4/view/bj;->e:F
...
.method private a(IZIZ)V
    ...
    invoke-virtual {p0, p1}, Landroid/support/v4/view/ViewPager;->b(I)Landroid/support/v4/view/bj;
    ...
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->W:Landroid/support/v4/view/bn;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->W:Landroid/support/v4/view/bn;

    invoke-interface {v0, p1}, Landroid/support/v4/view/bn;->a(I)V

    :cond_0
    if-eqz p4, :cond_1

    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->Z:Landroid/support/v4/view/bn;
    ...
    iget-object v2, p0, Landroid/support/v4/view/ViewPager;->W:Landroid/support/v4/view/bn;

    if-eqz v2, :cond_3

    iget-object v2, p0, Landroid/support/v4/view/ViewPager;->W:Landroid/support/v4/view/bn;

    invoke-interface {v2, p1}, Landroid/support/v4/view/bn;->a(I)V

    :cond_3
    if-eqz p4, :cond_4

    iget-object v2, p0, Landroid/support/v4/view/ViewPager;->Z:Landroid/support/v4/view/bn;
...
.method private a(Landroid/support/v4/view/bj;ILandroid/support/v4/view/bj;)V
    .locals 11
    ...
    iget v0, p3, Landroid/support/v4/view/bj;->b:I

    iget v1, p1, Landroid/support/v4/view/bj;->b:I

    if-ge v0, v1, :cond_3

    iget v1, p3, Landroid/support/v4/view/bj;->e:F

    iget v2, p3, Landroid/support/v4/view/bj;->d:F
    ...
    :goto_2
    iget v5, v0, Landroid/support/v4/view/bj;->b:I
    ...
    :cond_2
    iput v3, v0, Landroid/support/v4/view/bj;->e:F

    iget v0, v0, Landroid/support/v4/view/bj;->d:F
    ...
    iget v3, p3, Landroid/support/v4/view/bj;->e:F
    ...
    :cond_5
    iget v5, v0, Landroid/support/v4/view/bj;->d:F
    ...
    iget v2, p1, Landroid/support/v4/view/bj;->e:F
    ...
    iget v0, p1, Landroid/support/v4/view/bj;->e:F
    ...
    iget v3, p1, Landroid/support/v4/view/bj;->d:F
    ...
    :goto_a
    iget v2, v0, Landroid/support/v4/view/bj;->b:I
    ...
    :cond_9
    iget v2, v0, Landroid/support/v4/view/bj;->d:F

    add-float/2addr v2, v6

    sub-float v2, v3, v2

    iput v2, v0, Landroid/support/v4/view/bj;->e:F
    ...
    iget v1, p1, Landroid/support/v4/view/bj;->d:F
...
.method private a(Z)V
    ...
    iget-boolean v5, v0, Landroid/support/v4/view/bj;->c:Z

    if-eqz v5, :cond_2

    iput-boolean v2, v0, Landroid/support/v4/view/bj;->c:Z
...
.method private b(F)Z
    ...
    iget v8, v0, Landroid/support/v4/view/bj;->b:I
    ...
    :goto_0
    iget v8, v1, Landroid/support/v4/view/bj;->b:I
    ...
    iget v1, v1, Landroid/support/v4/view/bj;->e:F
...
.method private d(I)Z
    ...
    :cond_0
    invoke-direct {p0}, Landroid/support/v4/view/ViewPager;->i()Landroid/support/v4/view/bj;
    ...
    iget v5, v1, Landroid/support/v4/view/bj;->b:I
    ...
    iget v6, v1, Landroid/support/v4/view/bj;->e:F

    sub-float/2addr v2, v6

    iget v1, v1, Landroid/support/v4/view/bj;->d:F
...
.method private g()V
    ...
    iget-boolean v0, v0, Landroid/support/v4/view/bk;->a:Z
...
.method private h()V
    ...
    sget-object v1, Landroid/support/v4/view/ViewPager;->af:Landroid/support/v4/view/br;
...
.method private i()Landroid/support/v4/view/bj;
    .locals 13
    ...
    iget v10, v0, Landroid/support/v4/view/bj;->b:I

    add-int/lit8 v11, v8, 0x1

    if-eq v10, v11, :cond_6

    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->f:Landroid/support/v4/view/bj;

    add-float/2addr v6, v7

    add-float/2addr v6, v1

    iput v6, v0, Landroid/support/v4/view/bj;->e:F

    add-int/lit8 v6, v8, 0x1

    iput v6, v0, Landroid/support/v4/view/bj;->b:I

    iget-object v6, p0, Landroid/support/v4/view/ViewPager;->h:Landroid/support/v4/view/ae;

    iget v7, v0, Landroid/support/v4/view/bj;->b:I

    invoke-virtual {v6, v7}, Landroid/support/v4/view/ae;->b(I)F

    move-result v6

    iput v6, v0, Landroid/support/v4/view/bj;->d:F
    ...
    :goto_3
    iget v6, v2, Landroid/support/v4/view/bj;->e:F

    iget v7, v2, Landroid/support/v4/view/bj;->d:F
    ...
    :cond_5
    iget v5, v2, Landroid/support/v4/view/bj;->b:I

    iget v4, v2, Landroid/support/v4/view/bj;->d:F
...
.method private setScrollState(I)V
    ...
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->ab:Landroid/support/v4/view/bo;
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/view/bn;->b(I)V
...
.method a(II)Landroid/support/v4/view/bj;
    .locals 2
    ...
    iput p1, v0, Landroid/support/v4/view/bj;->b:I
    ...
    iput-object v1, v0, Landroid/support/v4/view/bj;->a:Ljava/lang/Object;
    ...
    iput v1, v0, Landroid/support/v4/view/bj;->d:F
...
.method a(Landroid/view/View;)Landroid/support/v4/view/bj;
    .locals 4
    ...
    iget-object v3, v0, Landroid/support/v4/view/bj;->a:Ljava/lang/Object;
...
.method a()V
    ...
    invoke-static {v1}, Landroid/support/v4/view/ba;->a(Landroid/view/ViewConfiguration;)I
    ...
    iput-object v1, p0, Landroid/support/v4/view/ViewPager;->Q:Landroid/support/v4/widget/e;

    new-instance v1, Landroid/support/v4/widget/e;

    invoke-direct {v1, v0}, Landroid/support/v4/widget/e;-><init>(Landroid/content/Context;)V

    iput-object v1, p0, Landroid/support/v4/view/ViewPager;->R:Landroid/support/v4/widget/e;
    ...
    invoke-direct {v0, p0}, Landroid/support/v4/view/bl;-><init>(Landroid/support/v4/view/ViewPager;)V
...
.method a(I)V
    ...
    invoke-virtual {v0, v3}, Landroid/support/v4/view/ViewPager;->b(I)Landroid/support/v4/view/bj;
    ...
    iget v7, v2, Landroid/support/v4/view/bj;->b:I
    ...
    invoke-virtual {v0, v2, v5}, Landroid/support/v4/view/ViewPager;->a(II)Landroid/support/v4/view/bj;
    ...
    :cond_5
    iget v6, v10, Landroid/support/v4/view/bj;->d:F
    ...
    invoke-direct {v0, v10, v8, v4}, Landroid/support/v4/view/ViewPager;->a(Landroid/support/v4/view/bj;ILandroid/support/v4/view/bj;)V
    ...
    iget-object v2, v10, Landroid/support/v4/view/bj;->a:Ljava/lang/Object;
    ...
    check-cast v2, Landroid/support/v4/view/bk;

    iput v4, v2, Landroid/support/v4/view/bk;->f:I

    iget-boolean v7, v2, Landroid/support/v4/view/bk;->a:Z

    if-nez v7, :cond_8

    iget v7, v2, Landroid/support/v4/view/bk;->c:F
    ...
    invoke-virtual {v0, v6}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Landroid/support/v4/view/bj;

    move-result-object v6

    if-eqz v6, :cond_8

    iget v7, v6, Landroid/support/v4/view/bj;->d:F

    iput v7, v2, Landroid/support/v4/view/bk;->c:F

    iget v6, v6, Landroid/support/v4/view/bj;->b:I

    iput v6, v2, Landroid/support/v4/view/bk;->e:I
    ...
    iget v7, v10, Landroid/support/v4/view/bj;->d:F
    ...
    :cond_c
    iget v15, v2, Landroid/support/v4/view/bj;->b:I

    if-ne v9, v15, :cond_d

    iget-boolean v15, v2, Landroid/support/v4/view/bj;->c:Z
    ...
    iget-object v2, v2, Landroid/support/v4/view/bj;->a:Ljava/lang/Object;
    ...
    iget v2, v2, Landroid/support/v4/view/bj;->d:F
    ...
    invoke-virtual {v0, v9, v2}, Landroid/support/v4/view/ViewPager;->a(II)Landroid/support/v4/view/bj;
    ...
    :cond_15
    iget v11, v2, Landroid/support/v4/view/bj;->b:I

    if-ne v9, v11, :cond_20

    iget-boolean v11, v2, Landroid/support/v4/view/bj;->c:Z
    ...
    invoke-virtual {v0, v9, v7}, Landroid/support/v4/view/ViewPager;->a(II)Landroid/support/v4/view/bj;
    ...
    invoke-virtual {v0, v2}, Landroid/support/v4/view/ViewPager;->b(Landroid/view/View;)Landroid/support/v4/view/bj;
    ...
    iget v2, v2, Landroid/support/v4/view/bj;->b:I
    ...
    invoke-virtual {v0, v4}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Landroid/support/v4/view/bj;

    move-result-object v5

    if-eqz v5, :cond_1e

    iget v5, v5, Landroid/support/v4/view/bj;->b:I
...
.method protected a(IFI)V
    ...
    iget-boolean v9, v0, Landroid/support/v4/view/bk;->a:Z
    ...
    :cond_1
    iget v0, v0, Landroid/support/v4/view/bk;->b:I
    ...
    invoke-interface {v0, p1, p2, p3}, Landroid/support/v4/view/bn;->a(IFI)V
    ...
    iget-object v5, p0, Landroid/support/v4/view/ViewPager;->ab:Landroid/support/v4/view/bo;

    invoke-interface {v5, v3, v0}, Landroid/support/v4/view/bo;->a(Landroid/view/View;F)V
...
.method a(IZZI)V
    ...
    iput-boolean v3, v0, Landroid/support/v4/view/bj;->c:Z
...
.method public addFocusables(Ljava/util/ArrayList;II)V
    ...
    invoke-virtual {p0, v3}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Landroid/support/v4/view/bj;

    move-result-object v4

    if-eqz v4, :cond_0

    iget v4, v4, Landroid/support/v4/view/bj;->b:I
...
.method public addTouchables(Ljava/util/ArrayList;)V
    ...
    invoke-virtual {p0, v1}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Landroid/support/v4/view/bj;
...
.method public addView(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V
    ...
    iget-boolean v2, v0, Landroid/support/v4/view/bk;->a:Z

    instance-of v3, p1, Landroid/support/v4/view/bi;

    or-int/2addr v2, v3

    iput-boolean v2, v0, Landroid/support/v4/view/bk;->a:Z
    ...
    iput-boolean v2, v0, Landroid/support/v4/view/bk;->d:Z
...
.method b(I)Landroid/support/v4/view/bj;
    .locals 3
...
.method b(Landroid/view/View;)Landroid/support/v4/view/bj;
    .locals 2
    ...
    :cond_2
    invoke-virtual {p0, p1}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Landroid/support/v4/view/bj;
...
.method b()V
    ...
    iget-object v9, v0, Landroid/support/v4/view/bj;->a:Ljava/lang/Object;
    ...
    :cond_3
    iget v9, v0, Landroid/support/v4/view/bj;->b:I

    if-eq v9, v7, :cond_a

    iget v6, v0, Landroid/support/v4/view/bj;->b:I
    ...
    :cond_4
    iput v7, v0, Landroid/support/v4/view/bj;->b:I
    ...
    iget-boolean v6, v0, Landroid/support/v4/view/bk;->a:Z

    if-nez v6, :cond_7

    const/4 v6, 0x0

    iput v6, v0, Landroid/support/v4/view/bk;->c:F
...
.method public generateLayoutParams(Landroid/util/AttributeSet;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-direct {v0, v1, p1}, Landroid/support/v4/view/bk;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method protected getChildDrawingOrder(II)I
    ...
    iget v0, v0, Landroid/support/v4/view/bk;->f:I
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    iget v4, v1, Landroid/support/v4/view/bj;->e:F
    ...
    iget v3, v1, Landroid/support/v4/view/bj;->b:I
    ...
    iget v10, v2, Landroid/support/v4/view/bj;->b:I
    ...
    iget v3, v1, Landroid/support/v4/view/bj;->e:F

    iget v4, v1, Landroid/support/v4/view/bj;->d:F
    ...
    iget v11, v1, Landroid/support/v4/view/bj;->d:F
...
.method protected onLayout(ZIIII)V
    ...
    check-cast v1, Landroid/support/v4/view/bk;

    iget-boolean v7, v1, Landroid/support/v4/view/bk;->a:Z

    if-eqz v7, :cond_5

    iget v7, v1, Landroid/support/v4/view/bk;->b:I

    and-int/lit8 v7, v7, 0x7

    iget v1, v1, Landroid/support/v4/view/bk;->b:I
    ...
    iget-boolean v10, v1, Landroid/support/v4/view/bk;->a:Z

    if-nez v10, :cond_2

    move-object/from16 v0, p0

    invoke-virtual {v0, v8}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Landroid/support/v4/view/bj;
    ...
    iget v10, v10, Landroid/support/v4/view/bj;->e:F
    ...
    iget-boolean v12, v1, Landroid/support/v4/view/bk;->d:Z

    if-eqz v12, :cond_1

    const/4 v12, 0x0

    iput-boolean v12, v1, Landroid/support/v4/view/bk;->d:Z

    int-to-float v12, v7

    iget v1, v1, Landroid/support/v4/view/bk;->c:F
...
.method protected onMeasure(II)V
    ...
    iget-boolean v1, v0, Landroid/support/v4/view/bk;->a:Z

    if-eqz v1, :cond_3

    iget v1, v0, Landroid/support/v4/view/bk;->b:I
    ...
    :cond_2
    :goto_3
    iget v4, v0, Landroid/support/v4/view/bk;->width:I
    ...
    iget v2, v0, Landroid/support/v4/view/bk;->width:I
    ...
    :goto_4
    iget v11, v0, Landroid/support/v4/view/bk;->height:I
    ...
    iget v0, v0, Landroid/support/v4/view/bk;->height:I
    ...
    iget-boolean v5, v0, Landroid/support/v4/view/bk;->a:Z
    ...
    iget v0, v0, Landroid/support/v4/view/bk;->c:F
...
.method protected onRequestFocusInDescendants(ILandroid/graphics/Rect;)Z
    ...
    invoke-virtual {p0, v5}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Landroid/support/v4/view/bj;
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget v5, v4, Landroid/support/v4/view/bj;->b:I
    ...
    iget v3, v4, Landroid/support/v4/view/bj;->e:F

    sub-float/2addr v2, v3

    iget v3, v4, Landroid/support/v4/view/bj;->d:F
...
.method public setAdapter(Landroid/support/v4/view/ae;)V
    ...
    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->n:Landroid/support/v4/view/bp;
    ...
    iget v4, v0, Landroid/support/v4/view/bj;->b:I

    iget-object v0, v0, Landroid/support/v4/view/bj;->a:Ljava/lang/Object;
    ...
    invoke-direct {v1, p0, v5}, Landroid/support/v4/view/bp;-><init>(Landroid/support/v4/view/ViewPager;Landroid/support/v4/view/bf;)V

    iput-object v1, p0, Landroid/support/v4/view/ViewPager;->n:Landroid/support/v4/view/bp;

    :cond_2
    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->h:Landroid/support/v4/view/ae;

    iget-object v3, p0, Landroid/support/v4/view/ViewPager;->n:Landroid/support/v4/view/bp;
    ...
    :cond_3
    :goto_1
    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->aa:Landroid/support/v4/view/bm;
    ...
    invoke-interface {v1, v0, p1}, Landroid/support/v4/view/bm;->a(Landroid/support/v4/view/ae;Landroid/support/v4/view/ae;)V
...
.method setOnAdapterChangeListener(Landroid/support/v4/view/bm;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v4/view/ViewPager;->aa:Landroid/support/v4/view/bm;

    return-void
.end method

.method public setOnPageChangeListener(Landroid/support/v4/view/bn;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v4/view/ViewPager;->W:Landroid/support/v4/view/bn;
