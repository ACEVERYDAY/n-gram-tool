...
.field protected aj:Landroid/widget/LinearLayout;

.field protected ak:Landroid/widget/RelativeLayout;

.field protected al:Landroid/widget/LinearLayout;
...
.method public constructor <init>(Landroid/app/Activity;)V
    ...
    iput-object v0, p0, Lcom/ipaynow/plugin/a/a/a;->af:Landroid/app/Activity;

    iput v8, p0, Lcom/ipaynow/plugin/a/a/a;->ag:I

    iput v8, p0, Lcom/ipaynow/plugin/a/a/a;->ah:I

    iput-object v0, p0, Lcom/ipaynow/plugin/a/a/a;->ai:Landroid/widget/RelativeLayout;

    iput-object v0, p0, Lcom/ipaynow/plugin/a/a/a;->aj:Landroid/widget/LinearLayout;

    iput-object v0, p0, Lcom/ipaynow/plugin/a/a/a;->ak:Landroid/widget/RelativeLayout;

    iput-object v0, p0, Lcom/ipaynow/plugin/a/a/a;->al:Landroid/widget/LinearLayout;

    iput-object v0, p0, Lcom/ipaynow/plugin/a/a/a;->am:Landroid/widget/RelativeLayout;

    iput-object v0, p0, Lcom/ipaynow/plugin/a/a/a;->an:Ljava/util/ArrayList;

    iput-object p1, p0, Lcom/ipaynow/plugin/a/a/a;->af:Landroid/app/Activity;
    ...
    iput v1, p0, Lcom/ipaynow/plugin/a/a/a;->ag:I

    const/4 v1, 0x1

    aget v0, v0, v1

    iput v0, p0, Lcom/ipaynow/plugin/a/a/a;->ah:I
    ...
    iget-object v0, p0, Lcom/ipaynow/plugin/a/a/a;->an:Ljava/util/ArrayList;

    new-instance v1, Landroid/widget/RelativeLayout;

    iget-object v2, p0, Lcom/ipaynow/plugin/a/a/a;->af:Landroid/app/Activity;
    ...
    iget-object v4, p0, Lcom/ipaynow/plugin/a/a/a;->af:Landroid/app/Activity;
    ...
    iget-object v6, p0, Lcom/ipaynow/plugin/a/a/a;->af:Landroid/app/Activity;
...
.method public final d()Landroid/widget/RelativeLayout;
    ...
    iget-object v0, p0, Lcom/ipaynow/plugin/a/a/a;->af:Landroid/app/Activity;

    invoke-virtual {v0, v3}, Landroid/app/Activity;->requestWindowFeature(I)Z

    new-instance v0, Landroid/widget/RelativeLayout;

    iget-object v1, p0, Lcom/ipaynow/plugin/a/a/a;->af:Landroid/app/Activity;

    invoke-direct {v0, v1}, Landroid/widget/RelativeLayout;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/ipaynow/plugin/a/a/a;->ai:Landroid/widget/RelativeLayout;

    iget-object v0, p0, Lcom/ipaynow/plugin/a/a/a;->ai:Landroid/widget/RelativeLayout;
    ...
    iget-object v0, p0, Lcom/ipaynow/plugin/a/a/a;->aj:Landroid/widget/LinearLayout;
    ...
    iget-object v4, p0, Lcom/ipaynow/plugin/a/a/a;->aj:Landroid/widget/LinearLayout;
    ...
    iget-object v3, p0, Lcom/ipaynow/plugin/a/a/a;->af:Landroid/app/Activity;

    invoke-direct {v2, v3}, Landroid/widget/RelativeLayout;-><init>(Landroid/content/Context;)V

    iput-object v2, p0, Lcom/ipaynow/plugin/a/a/a;->ak:Landroid/widget/RelativeLayout;

    new-instance v2, Landroid/widget/FrameLayout$LayoutParams;

    invoke-direct {v2, v5, v5}, Landroid/widget/FrameLayout$LayoutParams;-><init>(II)V

    iget-object v3, p0, Lcom/ipaynow/plugin/a/a/a;->ak:Landroid/widget/RelativeLayout;
    ...
    iput-object v2, p0, Lcom/ipaynow/plugin/a/a/a;->am:Landroid/widget/RelativeLayout;

    iget-object v2, p0, Lcom/ipaynow/plugin/a/a/a;->am:Landroid/widget/RelativeLayout;
    ...
    iget-object v3, p0, Lcom/ipaynow/plugin/a/a/a;->am:Landroid/widget/RelativeLayout;

    invoke-virtual {v3, v2}, Landroid/widget/RelativeLayout;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V

    iget-object v2, p0, Lcom/ipaynow/plugin/a/a/a;->ai:Landroid/widget/RelativeLayout;

    iget-object v3, p0, Lcom/ipaynow/plugin/a/a/a;->aj:Landroid/widget/LinearLayout;
    ...
    invoke-static {v0}, Lcom/ipaynow/plugin/utils/c;->e(Landroid/content/Context;)Lcom/ipaynow/plugin/utils/c;

    move-result-object v0

    iget-object v1, p0, Lcom/ipaynow/plugin/a/a/a;->af:Landroid/app/Activity;

    invoke-virtual {v0, v1}, Lcom/ipaynow/plugin/utils/c;->b(Landroid/app/Activity;)V

    iget-object v1, p0, Lcom/ipaynow/plugin/a/a/a;->aj:Landroid/widget/LinearLayout;
    ...
    iget-object v0, p0, Lcom/ipaynow/plugin/a/a/a;->ak:Landroid/widget/RelativeLayout;
